    ...
    <div className="animate-fade-in">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-white mb-2">
          🤖 Chatbot <span className="gradient-text">Entrenador</span>
        </h2>
        <p className="text-gray-400">Pide rutinas personalizadas y consejos de entrenamiento</p>
      </div>
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="glass-card h-[500px] flex flex-col overflow-hidden">
          ...
          <div className="border-t border-white/10 p-4">
            ...
            <p className="text-xs text-gray-500 mt-2">Enter para enviar • Shift+Enter para nueva linea</p>
          </div>
        </div>
      </div>
    </div>
